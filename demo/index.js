...
import '../px-demo-api-viewer.js';
import '../px-demo-footer.js';
import '../px-demo-configs.js';
import '../px-demo-props.js';
import '../px-demo-interactive.js';
import '../px-demo-component-snippet.js';
import '../px-demo-code-editor.js';
...
Polymer({
  _template: html`
    <!-- Header -->
    <px-demo-header module-name="px-demo" description="px-demo is used as a template to build the component demos. These demos live on predix-ui.com" desktop="" tablet="">
    </px-demo-header>
    ...
    <px-demo-interactive>
      ...
      <px-demo-component slot="px-demo-component">
        ...
        <div style="width:250px">
          <px-calendar-picker display-mode="{{props.displayMode.value}}" block-future-dates="{{props.blockFutureDates.value}}" block-past-dates="{{props.blockPastDates.value}}" prevent-range-selection="{{props.preventRangeSelection.value}}" hide-next-button="{{props.hideNextButton.value}}" hide-previous-button="{{props.hidePreviousButton.value}}" block-dates-before="{{props.blockDatesBefore.value}}" block-dates-after="{{props.blockDatesAfter.value}}">
          </px-calendar-picker>
        </div>
      </px-demo-component>
      <!-- END Component ------------------------------------------------------>

      <px-demo-component-snippet slot="px-demo-component-snippet" element-properties="{{props}}" element-name="px-calendar-picker" links-includes="[[linksIncludes]]">
