...
function runBaseTests() {
  px_demo_1 = document.getElementById('px_demo_1');

  suite('Base Automation Tests for px-demo', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-demo fixture is created', function() {
      assert.isTrue(document.getElementById('px_demo_1') !== null);
    });
